...
JEITO MAIS FACIL (WINDOWS): dois cliques em iniciar.bat
    Ele procura o Python (python.org, py, Anaconda ou Miniconda), cria o .venv,
    instala as bibliotecas, confere o ambiente e abre a interface no navegador.

VERIFICAR O COMPUTADOR
    python src/verificar_ambiente.py
    Mostra versao do Python, bibliotecas, microfones e quantos audios existem.

TROCAR DE COMPUTADOR
    Interface > Configuracoes > Backup: "Preparar backup" gera um .zip com
    datasets, modelos e reunioes. No outro PC, "Restaurar" esse .zip
    (arquivos que ja existem nao sao substituidos).
...
GRAVAR DE CASA (GRUPO PELO GITHUB)
Cada integrante clona o repositorio, grava SO a propria voz e envia.
1) Primeira vez: GitHub Desktop > File > Clone repository > escolha o repositorio.
2) Antes de gravar: clique em "Fetch origin" / "Pull origin" (pega o que as outras gravaram).
3) Dois cliques em iniciar.bat > aba Datasets:
   - Pessoas: escolha o SEU nome e grave 20 a 30 frases.
   - Emocoes: em "Quem esta gravando" escolha o SEU nome e grave as 4 emocoes.
4) Feche o app. No GitHub Desktop: escreva um resumo (ex.: "audios da dani"),
   clique em "Commit to main" e depois "Push origin".
Os nomes dos arquivos levam o nome de quem gravou (dani_001.wav, alegre_dani_001.wav),
entao ninguem sobrescreve o audio de ninguem.
Nao vao para o GitHub: .venv, config.json, modelos/ e reunioes/ (sao gerados em cada PC).
Quem vai apresentar faz o Pull de tudo, treina os modelos e roda a reuniao.
